...
public class LogUtils {
    public static String customTagPrefix = "wxj"; // 自定义Tag的前缀，可以是作者名
...
//        Log.e(tag, msg);
    ...
    public static void e(String content) {
        ...
        if (isSaveLog) {
            //point(Constant.PATH_LOG_INFO, tag, content);
        }
    }
    ...
    public static void e(String content, Throwable tr) {
        ...
        if (isSaveLog) {
            //point(Constant.PATH_LOG_INFO, tag, tr.getMessage());
        }
    }
    ...
    public static void e(Throwable tr) {
        ...
        if (isSaveLog) {
            //point(Constants.PATH_LOG_INFO, tag, tr.getMessage());
        }
    }
